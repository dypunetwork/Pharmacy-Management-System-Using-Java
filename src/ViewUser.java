...
public class ViewUser extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(6, 95, 838, 348));

        jLabel2.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        jLabel2.setText("Click on row to Delete User");
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(326, 461, -1, -1));
    ...
    private void formComponentShown(java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_formComponentShown
        ...
        try
        {
            ...
            while(rs.next())
            {
                model.addRow(new Object[]{rs.getString("appuser_pk"),rs.getString("name"),rs.getString("userRole"),rs.getString("mobileNumber"),rs.getString("dob"),rs.getString("email"),rs.getString("username"),rs.getString("password"),rs.getString("address")});
            }
        }
        catch(Exception e)
        {
        ...
        else
        {
            ...
            if(a==0)
            {
                try
                {
                    ...
                    ps.setString(1, id);
                    ps.executeUpdate();
                    JOptionPane.showMessageDialog(null, "Username Successfully Deleted");
                    setVisible(false);
